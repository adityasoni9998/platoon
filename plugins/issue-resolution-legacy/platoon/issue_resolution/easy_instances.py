"""The 257 SWE-Smith instances used by the legacy easy training run.

Recovered from platoon commit dd43ec0, where this exact subset was the
successful easy-set checkpoint. Keep this explicit so dataset updates cannot
silently change the training population.
"""

EASY_SWE_SMITH_INSTANCE_IDS = frozenset(
    {
