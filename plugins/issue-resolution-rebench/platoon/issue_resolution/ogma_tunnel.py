...
OGMA_SSH_TARGET = os.environ.get(
    "PLATOON_OGMA_SSH_TARGET",
    "adityabs@ogma.lti.cs.cmu.edu",
)
OGMA_PUBLIC_HOST = os.environ.get(
    "PLATOON_OGMA_PUBLIC_HOST",
    "ogma.lti.cs.cmu.edu",
)
...
class OgmaReverseTunnelManager:
    """Own one SSH ControlMaster carrying all AReaL reverse forwards."""
    ...
    def _control_command(self, *args: str) -> list[str]:
        ...
        return ["ssh", "-S", str(self._control_socket), *args, OGMA_SSH_TARGET]

    def _start_master(self) -> None:
        self._temp_dir = tempfile.TemporaryDirectory(prefix="issue-resolution-rebench-ogma-")
