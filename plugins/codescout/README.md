...
apptainer pull $APPTAINER_CACHEDIR/docker.io_adityasoni8_eval-agent-server_43376f1-codescout-custom-image-source-minimal.sif docker://docker.io/adityasoni8/eval-agent-server:43376f1-codescout-custom-image-source-minimal
```
