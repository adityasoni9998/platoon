...
#   - "platoon.codescout_sail.custom_tools.localization_finish"  (via the platoon package)
#   - "custom_tools.localization_finish"                    (via the .pth entry for plugins/codescout_sail)
#
...
_LONG = "platoon.codescout_sail.custom_tools.localization_finish"
_PLUGINS = "plugins.codescout_sail.platoon.codescout_sail.custom_tools.localization_finish"
_SHORT_PKG = "custom_tools"
_LONG_PKG = "platoon.codescout_sail.custom_tools"
